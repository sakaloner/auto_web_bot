...
export declare function set_data_dev(text: Text, data: unknown): void;
export declare function set_data_contenteditable_dev(text: Text, data: unknown): void;
export declare function set_data_maybe_contenteditable_dev(text: Text, data: unknown, attr_value: string): void;
